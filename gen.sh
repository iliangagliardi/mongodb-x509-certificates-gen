...
# cert ca gen
openssl req -new -x509 -days $DAYS_ROOT_CA -key mongodb-ca.key -out mongodb-ca.crt -config mongodb-ca.cfg -subj "$dn_prefix/CN=ROOT-CA"
...
echo "##### STEP 3: Create client certificates"
